...
const Contact = () => {
  ...
  return (
    <section className="h-[120vh] z-30" id="contact">
      <motion.div
        ref={ref}
        className="h-full max-w-7xl m-auto flex flex-col lg:flex-row items-center lg:gap-12 z-50"
        variants={variants}
        initial="initial"
        whileInView="animate"
      >
        <motion.div className="text-white lg:flex-1 flex flex-col lg:gap-10 gap-5 mt-32 lg:mt-0 text-center lg:text-start items-center lg:items-start" variants={variants}>
          ...
          <motion.div className="item" variants={variants}>
            <h2>Phone</h2>
            <span>+212 643971872</span>
          </motion.div>
        </motion.div>
        <div className="flex-1 relative p-12 lg:p-0 w-full">
          <motion.div
            className="stroke-indigo-600 absolute m-auto -z-[1]"
            initial={{ opacity: 1 }}
