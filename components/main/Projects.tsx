...
const items = [
  {
    id: 0,
    title: "Gucci",
    img: "https://ucarecdn.com/24f924b1-7213-41aa-821e-12e44e734fd4/",
    link: "https://gucci-v2.vercel.app/",
    desc: "Gucci Landing Page recreated with next.js and tailwind Css",
  },
  {
    id: 1,
    title: "Mercedes Benz",
    img: "https://ucarecdn.com/82c334c8-c296-476f-9341-88011eadc8c1/",
    ...
    <section id="projects">
      <div className="flex flex-col md:flex-row mt-10 md:mt-0 items-center justify-center w-full h-full overflow-hidden">
        <div className="max-w-7xl h-auto flex flex-col md:flex-row items-center justify-center gap-[50px]">
          ...
          <motion.div
            className="text-center items-center md:items-start md:text-start p-3 flex flex-1 flex-col gap-7 text-white transform-none z-50 mt-64 md:mt-0"
            style={{ y }}
          >
            ...
            <a
              href={item.link}
              target="_blank"
              className="bg-indigo-600 border-none rounded-lg p-3 w-52 cursor-pointer text-center hover:scale-105 hover:bg-transparent transition-all"
            >
              See Demo
            </a>
          </motion.div>
